...
interactionInit = function(container) {
	Main.setObjective("Dikdörtgenin iç açıları toplamı 360° dir.")
	...
	var initializeAnimation = function () {
		...
		fullImage.opacity = 1;
		cornerA.position = new Point(
			fullImage.bounds.x+cornerB.bounds.width*0.5,
			fullImage.bounds.y+fullImage.bounds.height-cornerB.bounds.height*0.5			
		);//new Point(206.5,194);
		cornerB.position = new Point(
			fullImage.bounds.x+fullImage.bounds.width-cornerB.bounds.width*0.5,
			fullImage.bounds.y+fullImage.bounds.height-cornerB.bounds.height*0.5
			
		);//new Point(293.5,194);
		cornerC.position = new Point(
			fullImage.bounds.x+fullImage.bounds.width-cornerC.bounds.width*0.5,
			fullImage.bounds.y+cornerC.bounds.height*0.5
			
		);//new Point(293.5,107);
		
		cornerD.position = new Point(
			fullImage.bounds.x+cornerD.bounds.width*0.5,
			fullImage.bounds.y+cornerD.bounds.height*0.5
		);//new Point(206.5,107);
