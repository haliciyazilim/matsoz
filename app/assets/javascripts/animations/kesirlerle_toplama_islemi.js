var Animation = {
	init:function(container){
		...
		var arr = new Group(); 
		var arroww = new Path.OneSidedArrow(new Point(170, 164), new Point(650, 164), 10, 30);
		var arroww2 = new Path.OneSidedArrow(new Point(650, 164), new Point(651, 164), 10, 30);
		arroww.rotate(180);
		arr.addChild(arroww);
...
<<<<<<< HEAD
		...
		var bigDot2 = new Path.Circle(new Point(610.5, 164.5), 5);
=======
		var bigDot1 = new Path.Circle(new Point(210.5, 164.5), 4);
		bigDot1.strokeColor = "black";
		bigDot1.fillColor = "black";
		var bigDot2 = new Path.Circle(new Point(610.5, 164.5), 4);
>>>>>>> origin/abdullah-dev
		...
		for(i = 0; i < 7; i++){
<<<<<<< HEAD
			var smallDot = new Path.Circle(new Point(260.5+(50*i), 164.5), 3);
=======
			var smallDot = new Path.Circle(new Point(260.5+(50*i), 164.5), 2);
>>>>>>> origin/abdullah-dev
		...
		var arc = new Path.Arc(new Point(420, 140), new Point(460, 130), new Point(500, 140));
		arc.strokeColor = "black";
		var linee1 = new Path.Line(new Point(500,140), new Point(496,132));
		linee1.strokeColor = "black";
		var linee2 = new Path.Line(new Point(500,140), new Point(490,142));
