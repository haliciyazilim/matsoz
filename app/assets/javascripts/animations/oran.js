...
var Interaction = {
    ...
    init:function(container){
        ...
        cevapPayda="";
        sorular= new Array();
        maviBilyeGrubu=new Group();
        kirmiziBilyeGrubu=new Group();

        girdiPay=Interaction.appendInput({
            width:"30px",
            height:"30px",
            position:"relative"
        },true,false);
        ...
        girdiPayda=Interaction.appendInput({
            width:"30px",
            height:"30px",
            position:"relative"
        },true,false);
        ...
        $("#cerceve .girdiler",container).append(girdiPay);
        $("#cerceve .girdiler",container).append("<div class='kesir'>");
        $("#cerceve .girdiler",container).append(girdiPayda);

        $("#cerceve .girdiler input:first-child").attr("class","girdiPay");
        $("#cerceve .girdiler input:last-child").attr("class","girdiPayda");
        ...
        Interaction.appendButton({top:"230px", right:"25px"});
        Interaction.appendStatus({bottom:"120px", right:"0px",left:"0px", width:"300px",margin:"auto", textAlign:"center"});
    ...
    onFail : function(){
        ...
        Interaction.setStatus("Yanlış.<br />Doğru Cevap:",false);
    }
}
    ...
    function maviBilyeYap(){
        ...
        for(j=0;j<onluk && j<6;j++){
            ...
            for(i=0; i<girilenKareSayisi && i<10;i++){
                ...
                $(Interaction.container).append("<img class='mavi_bilye'  id='maviBilye"+idKontrol+"' src='/assets/animations/oran/bilye_mavi.png' />");
                $(maviBilyeId)
                    .css("position", "absolute")
                    .css("top",j*25+30)
                    .css("left", i*25+30);
    ...
    function kirmiziBilyeYap(){
        ...
        for(j=0;j<onluk && j<6;j++){
            ...
            for(i=0; i<girilenKareSayisi && i<10;i++){
                ...
                $(Interaction.container).append("<img class='kirmizi_bilye'  id='kirmiziBilye"+idKontrol+"' src='/assets/animations/oran/bilye_kirmizi.png' />");
                $(kirmiziBilyeId)
                    .css("position", "absolute")
                    .css("top",j*25+30)
                    .css("left", i*25+500);
