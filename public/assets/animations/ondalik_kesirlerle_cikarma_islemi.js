...
var Interaction = {
	...
	init:function(container){
            ...
            Main.setObjective('Yüzde birler basamağından itibaren çıkarma işlemini sırası geldiğinde uygun yere virgül koymayı unutmadan yapınız ve kontrol ediniz. (Cevabı yüzde birler basamağından başlayarak yazınız.)');
			Interaction.paper = {
